...
categories:
  - name: Watch Faces
    repos:
      - url: https://github.com/owner/watchface
        description: "Minimal digital watch face"

  - name: Data Fields
    repos:
      - url: https://github.com/owner/datafield

  - name: Tools
    subcategories:
      - name: SDK
        repos:
          - url: https://github.com/owner/connect-iq-tool
      - name: Companion Apps
        repos:
          - url: https://github.com/owner/companion-app
```
